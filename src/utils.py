...
def parse_arguments():
    ...
    parser.add_argument("--gpu_num", type=int, default=8, help="Specify the number of GPU, if more than, the number will be set to 5")
    parser.add_argument("--subv_dim", type=int, default=8, help="Specify the sub vector size")
